...
def create_sample_pdf():
    ...
    # Sample content about a fictional product manual
    content = """
    SMART HOME LED CONTROLLER
    MODEL: SH-LED-2024
    ...
    - Status LED (Multi-color): 
      ...
      * Red blinking: Error condition or overload
      * Blue blinking: Pairing mode active
      * Orange steady: Firmware update in progress
    ...
    The warranty covers defects in materials and workmanship under normal use. It does not cover damage caused by:
    - Misuse or abuse
    ...
    2. Describe the issue and provide photos if requested
    3. Follow return instructions if replacement is authorized
    4. Retain original packaging for returns
...
sample_content = create_sample_pdf()

# Save as a simple text file that can be converted to PDF
with open("c:\\Users\\USER\\Vishvam\\rag-assistant-phase1\\sample_data\\sample_content.txt", "w", encoding="utf-8") as f:
